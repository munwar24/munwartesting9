...
public class FlowRestService {
	...
	public String execute(String methodName, String json) {
		if (Login.authorization == null)
			return null;
		return execute(getContent(methodName, json));
	}
	...
	private String getContent(String methodName, String json) {
		GetActorStatus getActorStatus = UpdateController.getActorStatus;
		if (getActorStatus == null)
			return null;
		String content = "";
		content = "{\"call\":{\"id\":25,\"name\":\"@mobile.log\",\"data\":{"
				+ getItem("actor_id", getActorStatus.getActorId(), true)
				+ getItem("actor_name", getActorStatus.getActorName(), true)
				+ getItem("facility_id", getActorStatus.getFacilityId(), true)
				+ getItem("createdOn", toNowDate(), true)
				+ "\"message\":" + json
				+ "}},"
	...
	private String getContent(GetActionStatus getActionStatus, Event event) {
		...
		content = "{\"call\":{\"id\":25,\"name\":\"@mobile.actionStatusUpdate\",\"data\":{"
	...
	public static String toDOB(String stringTime) {
		...
		try {
			...
			String test = zuluFormat.format(calendar.getTime());
			// InstantMessageFragment.convertDate(test);
			// test = (date.getYear() + 1900) + "/" + (date.getMonth() + 1) +
			// "/" + (date.getDay() + 1);
	...
	private String getContent(String flowCallName, GetActionStatus getActionStatus, boolean create) {
		...
		content = "{\"call\":{\"id\":2,\"name\":\"@mobile.actionCreate\",\"data\":{"
	...
	private String getContent(String flowCallName, GetActorStatus getActorStatus) {
		...
		if (flowCallName.equals(GET_ACTION_HISTORY)) {
			...
			content = "{\"call\":{\"id\":10,\"name\":\"@mobile.actionSelect\",\"data\":{"
			...
			content = "{\"call\":{\"id\":13,\"name\":\"@mobile.actorStatusUpdate\",\"data\":{\"_id\":\""
		...
		// content =
		// "{\"call\":{\"id\":2,\"name\":\"@mobile.actionSelect\",\"data\":{"
	...
	private String getContent(String flowCallName, String arg1, String arg2) {
		...
		if (flowCallName.equals(GET_ACTOR_STATUS)) {
			content = "{\"call\":{\"id\":27,\"name\":\"@mobile.actorStatusSummary\",\"data\":{\"user_id\":\""
					+ emailAddress + "\"}},"
					+ "\"target\":\"iiCall\",\"authorization\":\""
			...
			content = "{\"call\":{\"id\":27,\"name\":\"@mobile.actorZoneUpdate\",\"data\":{\"user_id\":\""
					+ emailAddress + "\","
			...
			content = "{\"data\":{\"facility_id\": \""
					+ arg1
					+ "\"},"
					+ "\"criteria\":{\"store\":\"@mobile.locationsSelect\"},\"target\":\"iiCache\","
			...
			content = "{\"call\":{\"id\":1,\"name\":\"@mobile.availableZonesSelect\",\"data\":{\"facility_id\":\""
					+ arg2
					+ "\","
			...
			content = "{\"call\":{\"id\":10,\"name\":\"@mobile.mobileActionSelect\",\"data\":{\"_id\":\""
					+ arg1
					+ "\"}},\"target\":\"iiCall\",\"request\":11,\"location\":\"flow.testCenter.unitTester.\","
					+ "\"authorization\":\""
					+ Login.authorization
			...
			content = "{\"call\":{\"id\":2,\"name\":\"@mobile.mobileActorClasses\",\"data\":{\"facilityHirNode_id\": \""
					+ arg1
					+ "\","
	...
	// return
	// "user_role=43cb099aa3b59fbe81197b91bdb0216a36597fdf8eb8b03533450ce86298f994_4c7e303b5f9006250cfc47de65ddfdae..79dfb0b05efdda86d2f1282b73701287_1846c2ab9a6131c280058e71572f4f67..c4655b0d213e7d3bde7be88f07cad97ee5e15b35d7d1f510f6f373184785709c_ab37b8b2612660e03d913b4b1887dea2";
	// }
