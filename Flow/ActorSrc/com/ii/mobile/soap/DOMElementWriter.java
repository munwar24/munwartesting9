...
public class DOMElementWriter {
	...
	/**
	 * Writes a DOM tree to a stream in UTF8 encoding. Note that it prepends the
	 * &lt;?xml version='1.0' encoding='UTF-8'?&gt;. The indent number is set to
	 * 0 and a 2-space indent.
	 * 
	 * @param root
			...
			throws IOException
	{
		...
		for (int i = 0; element.hasChildNodes()
	 ...
	 * 
	 * <p>
	 * Also ensure that we are not including an <tt>]]&gt;</tt> marker by
	 * replacing that sequence with <tt>&amp;#x5d;&amp;#x5d;&amp;gt;</tt>.
	 * </p>
	 * </p>
	 * 
	 * @param value
	 ...
	 * 
	 * @param c
	 *            the character hose nature we'd like to determine.
	 * 
